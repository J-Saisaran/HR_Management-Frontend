        ...
        http.put(`/performances/${editingPerformance}/`, values)
            .then((res) => {
                const updatedRecords = performances.map((record) =>
                    record._id === editingPerformance._id ? res.data : record
                );
...
//             });
//     };
//     const handleEdit = (values, { setSubmitting, resetForm }) => {
//         http.put(`/performances/${id}/`, values)
//             .then((res) => {
//                 const updatedRecords = performances.map((record) =>
...
//                                         <TableCell>{performance.comments}</TableCell>
//                                         <TableCell>
//                                             <IconButton onClick={() => handleEdit(performance._id)} color="primary">
//                                                 <EditIcon />
//                                             </IconButton>
//                                         </TableCell>
//                                         <TableCell>
